...
train_encode_vocabulary = '../../data/jubenwang_data/train_encode_vocabulary'
train_decode_vocabulary = '../../data/jubenwang_data/train_decode_vocabulary'
...
with tf.Session() as sess:
	...
	if ckpt != None:
		...
		model.saver.restore(sess, "chatbot_model/ckpt-300000")
	else:
		print("没找到模型")
